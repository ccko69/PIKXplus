...
public interface ImageRegionDecoder {
   ...
   * dimensions of the image must be returned. The URI can be in one of the following formats: <br>
   * File: <code>file:///scard/picture.jpg</code> <br>
   * Asset: <code>file:///android_asset/picture.png</code> <br>
   ...
   * thread so it can safely load the image on the current thread. It is called from {@link
   ...
   * called concurrently.
   *
   * <p>See {@link SkiaImageRegionDecoder} and {@link SkiaPooledImageRegionDecoder} for examples of
